...
NAVER_NID_AUT     = os.environ.get('NAVER_NID_AUT', '')
NAVER_NID_SES     = os.environ.get('NAVER_NID_SES', '')
THREADS_COOKIE_JSON = os.environ.get('THREADS_COOKIE_JSON', '')
THREADS_USER_AGENT  = os.environ.get('THREADS_USER_AGENT', '')
...
THREADS_REFERENCES_FILE = os.path.join(BASE_DIR, "threads_references.json")
